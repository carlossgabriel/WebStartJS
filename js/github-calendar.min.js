    ...
    return function r(a, o, u) {
        ...
        1: [function (e, t, n) {
            ...
            t.exports = function (s, e, i) {
                s = l(s), (i = i || {}).summary_text = i.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>", i.cache = 1e3 * (i.cache || 86400), !1 === i.global_stats && (s.style.minHeight = "175px");
                var n = {
                    content: "gh_calendar_content." + e,
                    expire_at: "gh_calendar_expire." + e
                };
                return i.proxy = i.proxy || function (e) {
                    ...
                    function u() {
                        return i.getCalendar(e).then(function (e) {
                            ...
                            l(".position-relative h2", e).remove(), e.querySelector(".float-left.text-gray").innerHTML = i.summary_text, e.querySelector("include-fragment") ? setTimeout(u, 500) : (!0 === i.responsive && (r = (a = e.querySelector("svg.js-calendar-graph-svg")).getAttribute("width"), n = a.getAttribute("height"), a.removeAttribute("height"), a.setAttribute("width", "100%"), a.setAttribute("viewBox", "0 0 " + r + " " + n)), !1 !== i.global_stats && (a = (t = c(l("svg", e).outerHTML)).current_streak ? f(t.current_streak_range[0], g) + " &ndash; " + f(t.current_streak_range[1], g) : t.last_contributed ? "Last contributed in " + f(t.last_contributed, g) + "." : "Rock - Hard Place", r = t.longest_streak ? f(t.longest_streak_range[0], g) + " &ndash; " + f(t.longest_streak_range[1], g) : t.last_contributed ? "Last contributed in " + f(t.last_contributed, g) + "." : "Rock - Hard Place", n = l("<div>", {
                            ...
                            }), e.appendChild(n), e.appendChild(r), e.appendChild(a)), s.innerHTML = e.innerHTML, !0 === i.tooltips && (e = s, (o = document.createElement("div")).classList.add("day-tooltip"), e.appendChild(o), e.querySelectorAll("rect.day").forEach(function (e) {
                                e.addEventListener("mouseenter", function (e) {
                                    ...
                                    var n = new Date(e.target.getAttribute("data-date")),
                                        n = b[n.getUTCMonth()] + " " + n.getUTCDate() + ", " + n.getUTCFullYear();
                                    o.innerHTML = "<strong>" + t + "</strong> on " + n, o.classList.add("is-visible");
                                    n = e.target.getBoundingClientRect(), e = n.left + window.pageXOffset - o.offsetWidth / 2 + n.width / 2, n = n.bottom + window.pageYOffset - o.offsetHeight - 2 * n.height;
                                    o.style.top = n + "px", o.style.left = e + "px"
        ...
        8: [function (e, t, n) {
            var u = e("github-calendar-legend"),
                ...
                i = ["day", "day-L1", "day-L4", "day-L3", "day-L2"];
            t.exports = function (e) {
                ...
                return e.split("\n").slice(2).map(function (e) {
                    ...
                    var t = e.match(/fill="var\(\-\-color\-calendar\-graph\-([a-z0-9-]+)\-bg\)"/i),
                        ...
                        e = e && +e[1];
                    t && (t = {
                        fill: t = s[i.indexOf(t)],
                        date: new Date(n),
                        count: e,
                        level: u.indexOf(t)
                    }, 0 === a.current_streak && (a.current_streak_range[0] = t.date), t.count ? (++a.current_streak, a.last_year += t.count, a.last_contributed = t.date, a.current_streak_range[1] = t.date) : (r(), a.current_streak = 0), o.push(t), a.days.push(t))
                }), r(), a
            }
        }, {
                    ...
                    value: function (e, t) {
                        ...
                        do {
                            var r = e.match(this.re),
                                a = r && r[1],
                                r = a || e.charAt(0)
                        } while (a ? ("function" == typeof (a = this.obj[a]) && (a = a.apply(this, t)), n += a) : n += r, e = e.substring(r.length));
                        return n
                    }
                }]), s);
        ...
        13: [function (e, t, n) {
            t.exports = function (e, t, n) {
                ...
                for (void 0 !== n && (a = n < 0 ? n + a : n); a-- > o;) r[a - o] = e[a];
                return r
            }
        }, {}]
    }, {}, [1])(1)
